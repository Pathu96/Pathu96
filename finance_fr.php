  ...
  if (isset($_GET['psf'])){
    if (!empty($_GET['psf'])){
      ...
      if ($PSF_AVAILABLE > 0) {
        ...
        header("location:finance_fr_requests");
      }
...
<?php } ?>
                                          ...
                                          <?php } ?>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <select class="form-control" name="finance_approve">
                                                          <option value="Pending" <?php if($finance_approve == "Pending"){ echo("selected"); } ?>>Pending</option>
                                                          <option value="Approved" <?php if($finance_approve == "Approved"){ echo("selected"); } ?>>Approved</option>
                                                          <option value="Rejected" <?php if($finance_approve == "Rejected"){ echo("selected"); } ?>>Rejected</option>
                                                        </select>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" name="finance_remark" value="<?php echo($finance_remark); ?>">
                                                      </div>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-12">
                                                  <a class="btn btn-warning mr-1" onclick="printdiv('DATA-FORM');">Print</a>
                                                  <a href="fc?fr=<?php echo($id); ?>" class="btn btn-success mr-1">Go to Final Cost</a>
                                                  <button type="button" class="btn btn-primary mr-1 SUBMIT-DATA">Submit</button>
                                              </div>
                                          </div>
                                      </div>
                                  </form>
    ...
    <?php echo($finance_approve); if ($finance_approve == "Approved") { ?>
