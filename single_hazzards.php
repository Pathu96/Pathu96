        ...
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title text-center mb-0">Single Hazzards</h2>
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
<?php
        if (mysqli_query($link,"SELECT `id` FROM `hazzards` $WHERE_QUERY LIMIT 1")->num_rows > 0) {
?>
      <?php
               ...
               $statement = "`hazzards` ".$WHERE_QUERY; //you have to pass your query over here
...
<div class="modal fade text-start modal-primary" id="EDIT_DATA_MODAL" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <!-- BEGIN: Page JS-->
    <script src="assets/js/single_hazzards.js"></script>
    <!-- END: Page JS-->
    ...
    <script type="text/javascript">
      function exportReportToExcel() {
        ...
        TableToExcel.convert(table[0], { // html code may contain multiple tables so here we are refering to 1st table tag
          name: `Single Hazzards.xlsx`, // fileName you could use any name
          sheet: {
