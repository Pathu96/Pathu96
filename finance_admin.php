...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    <title>Finance Admin | Product Approval</title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Finance Admin</h2>
                  ...
                  <div class="card text-center">
                    <div class="card-content">
                      <div class="card-body">
                        ...
                        <h2 class="text-bold-700">Fuel Request</h2>
                  ...
                  <div class="card text-center">
                    <div class="card-content">
                      <div class="card-body">
                          ...
                          <h2 class="text-bold-700">Fuel Stock</h2>
                      </div>
                    </div>
                  </div>
                </a>
                  ...
                  <div class="card text-center">
                    <div class="card-content">
                      <div class="card-body">
                          ...
                          <h2 class="text-bold-700">User Registration</h2>
                      </div>
                    </div>
                  </div>
                </a>
