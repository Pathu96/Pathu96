                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
<?php
        if (mysqli_query($link,"SELECT `id` FROM `fr` WHERE `qa_approve` = 'Pending' LIMIT 1")->num_rows > 0) {
?>
      <?php
              ...
              $statement = "`fr` LEFT OUTER JOIN `psf` ON psf.`id` = fr.`psf_id` WHERE fr.`qa_approve` = 'Pending' "; //you have to pass your query over here
    ...
    <script type="text/javascript">
      function exportReportToExcel() {
        ...
        TableToExcel.convert(table[1], { // html code may contain multiple tables so here we are refering to 1st table tag
          name: `Formula Receipt Requests.xlsx`, // fileName you could use any name
          sheet: {
