                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-6">
                                                <div class="row">
                                                  ...
                                                  <div class="col-6">
                                                    <button type="button" class="btn btn-success float-right btn-sm ml-1" disabled>AI</button>
                                                    <button type="button" class="btn btn-primary float-right btn-sm ml-1" data-toggle="modal" data-target="#ADD_DATA_MODAL" disabled>+</button>
                                                    <button type="button" class="btn btn-info float-right btn-sm ml-1" data-toggle="modal" data-target="#IMPORT_DATA_MODAL" disabled>Import</button>
                                                  </div>
                                                </div>
                                                <hr class="mb-3">
...
<?php } ?>
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-12">
                                                      <div class="form-group row">
                                                          ...
                                                          <div class="col-md-10">
                                                            <input type="text" class="form-control" name="ph" value="<?php if($ph){ echo($ph); }?>" disabled>
                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-12">
                                                      <div class="form-group row">
                                                          ...
                                                          <div class="col-md-10">
                                                            <input type="text" class="form-control" name="vescosity" value="<?php if($vescosity){ echo($vescosity); } ?>" disabled>
                                                          </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-12">
                                                      <div class="form-group row">
                                                          ...
                                                          <div class="col-md-10">
                                                            <input type="color" class="form-control" name="color" value="<?php if($color){ echo($color); } ?>" disabled>
                                                          </div>
                                                      </div>
                                                  </div>
                                                </div>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" name="assign_person" value="<?php if($assign_person){ echo($assign_person); } ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="date" class="form-control" name="assign_date" value="<?php if($assign_date){ echo($assign_date); } ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" name="assign_duration" value="<?php if($assign_duration){ echo($assign_duration); } ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                          ...
                                          <?php if($qa_remark){ ?>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo($qa_remark); ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                          ...
                                          <?php if($finance_remark){ ?>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo($finance_remark); ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                          ...
                                          <?php if($finance_approve == 'Approved'){ ?>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" name="version_no" value="<?php echo($version_no); ?>">
                                                      </div>
                                                  </div>
                                              </div>
