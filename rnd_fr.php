...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    <title>Formula Receipt Request | Product Approval</title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title text-center mb-0">Formula Receipt Request</h2>
                                    ...
                                    <table class="table mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">QA Approval</th>
                                        ...
                                        <tbody>
<?php
        if (mysqli_query($link,"SELECT fr.`id` FROM `fr` LEFT OUTER JOIN `psf` ON psf.`id` = fr.`psf_id` LIMIT 1")->num_rows > 0) {
?>
      <?php
              ...
              $statement = "`fr` LEFT OUTER JOIN `psf` ON psf.`id` = fr.`psf_id` "; //you have to pass your query over here
      ...
      ?>
                                          <tr>
                                            ...
                                            <?php if($row['finance_approve'] == 'Approved'){ ?>
                                              <a href="rnd_fr_finalized?psf=<?= $row['psf_id'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit text-white"></i></a>
                                            <?php }else{ ?>
                                              <a href="fr?psf=<?= $row['psf_id'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit text-white"></i></a>
                                            <?php } ?>
