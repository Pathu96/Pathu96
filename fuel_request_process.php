...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    <title>Fuel Request Process | Product Approval</title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title text-center mb-0">Fuel Request Process</h2>
...
<div class="modal fade text-start modal-primary" id="SUBMIT_DATA_MODAL" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form form-horizontal" id="SUBMIT-DATA-FORM">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" name="litres" readOnly="readOnly">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" name="issued_date" value="<?php date_default_timezone_set("Asia/Colombo"); echo date('Y-m-d h:i a'); ?>" readOnly="readOnly">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" name="issued_by" value="<?php echo($_SESSION['project_user_name']); ?>"  readOnly="readOnly">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-12">
                        <div class="form-group row">
                            <div class="col-md-2">
                              <span>Issued Littres <small class="text-danger">*</small></span>
                            </div>
                            <div class="col-md-10">
                              <input type="number" class="form-control" min="0" name="issued_littres">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-12">
                        <div class="form-group row">
                            <div class="col-md-2">
                                <span>Issued Tank <small class="text-danger">*</small></span>
                            </div>
                            <div class="col-md-10">
                                <select class="form-control" name="issued_tank">
                                  <option value="Diesel - T1">Diesel - T1</option>
                                  <option value="Diesel - T2">Diesel - T2</option>
                                  <option value="Diesel - T3">Diesel - T3</option>
                                  <option value="Petrol - T1">Petrol - T1</option>
                                </select>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-12">
                        <button type="button" class="btn btn-success mr-1 mb-1 btn-block SUBMIT-DATA">Submit</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <!-- BEGIN: Page JS-->
    <script src="assets/js/fuel_request_process.js"></script>
    <!-- END: Page JS-->
