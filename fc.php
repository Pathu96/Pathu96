                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row justify-content-md-center">
                                                      ...
                                                      <div class="col-md-auto">
                                                        <input type="text" class="form-control" name="sample_value" value="<?php echo($sample_value); ?>">
                                                      </div>
                                                      <div class="col-md-2">
                                                        <input type="text" class="form-control" name="sample_cost" value="<?php echo($sample_cost); ?>">
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-12">
                                                  <div class="form-group row justify-content-md-center">
                                                      ...
                                                      <div class="col-md-auto">
                                                        <input type="text" class="form-control" name="value_for_cost" value="<?php echo($value_for_cost); ?>">
                                                      </div>
                                                      <div class="col-md-2">
                                                        <input type="text" class="form-control" name="cost_for_value" value="<?php echo($cost_for_value); ?>">
                                                      </div>
                                                  </div>
                                              </div>

                                          <?php if($marketing_remark){ ?>
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      <div class="col-md-2">
                                                        <span>Marketing Remark</span>
                                                      </div>
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo($marketing_remark); ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
