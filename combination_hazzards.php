...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    <title>Single Hazzards | Product Approval</title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title text-center mb-0">Combination Hazzards</h2>
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
<?php
        if (mysqli_query($link,"SELECT `id` FROM `hazzards` WHERE `i2_name` != '' LIMIT 1")->num_rows > 0) {
?>
      <?php
               ...
               $statement = "`hazzards` WHERE `i2_name` != ''"; //you have to pass your query over here
      ...
      ?>
                                          <tr>
                                            ...
                                            <td class="text-center"><?= $row['i1_name'] ?></td>
                                            <td class="text-center"><?= $row['i1_quantity'] ?></td>
                                            <td class="text-center"><?= $row['i1_unit'] ?></td>
                                            <td class="text-center"><?= $row['i2_name'] ?></td>
                                            <td class="text-center"><?= $row['i2_quantity'] ?></td>
                                            <td class="text-center"><?= $row['i2_unit'] ?></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Add Single Hazzard</h5>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i1_name">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i1_quantity">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i1_unit">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i2_name">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i2_quantity">
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="i2_unit">
                </div>
              </div>
            </div>
          </div>
...
<div class="modal fade text-start modal-primary" id="EDIT_DATA_MODAL" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit Single Hazzard</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="assets/js/combination_hazzards.js"></script>
    <!-- END: Page JS-->
    ...
    <script type="text/javascript">
      function exportReportToExcel() {
        ...
        TableToExcel.convert(table[0], { // html code may contain multiple tables so here we are refering to 1st table tag
          name: `Combination Hazzards.xlsx`, // fileName you could use any name
          sheet: {
