...
if (isset($_SESSION['project_user_id'])){
  ...
  if (!in_array($_SESSION['project_user_type'], ['finance_head'], true ) ) {
...
<div class="modal fade text-start modal-primary" id="APPROVE_DATA_MODAL" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
                    ...
                    <hr>
                        <div class="form-group row">
                            <div class="col-md-12">
                              ...
                              <br><br>
                              <input type="text" class="form-control" name="fh_comment">
                            </div>
                        </div>
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="assets/js/finance_request_approve.js"></script>
    <!-- END: Page JS-->
