                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
<?php
        if (mysqli_query($link,"SELECT fr.`id` FROM `fr` JOIN `fc` ON fc.`fr_id` = fr.`id` WHERE fr.`qa_approve` = 'Approved' LIMIT 1")->num_rows > 0) {
?>
      <?php
              ...
              $statement = "`fr` JOIN `fc` ON fc.`fr_id` = fr.`id` LEFT OUTER JOIN `psf` ON psf.`id` = fr.`psf_id` WHERE fr.`qa_approve` = 'Approved' "; //you have to pass your query over here
