...
if (isset($_SESSION['project_user_id'])){
  ...
  if ($_SESSION['project_user_type'] != "marketing_head") {
...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-6">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo($psf_id); ?>" disabled>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-6">
                                              ...
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <select class="form-control" name="marketing_approve">
                                                          <option value="Pending" <?php if($marketing_approve == "Pending"){ echo("selected"); } ?>>Pending</option>
                                                          <option value="Approved" <?php if($marketing_approve == "Approved"){ echo("selected"); } ?>>Approved</option>
                                                          <option value="Rejected" <?php if($marketing_approve == "Rejected"){ echo("selected"); } ?>>Rejected</option>
                                                        </select>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="col-12">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-md-10">
                                                        <input type="text" class="form-control" name="marketing_remark" value="<?php echo($marketing_remark); ?>">
                                                      </div>
                                                  </div>
                                              </div>

                                              <input type="hidden" name="FC_DATA" value="1">
                                              <!-- <input type="hidden" name="marketing_approve" value="Pending"> -->
                                              <!-- <input type="hidden" name="marketing_remark" value=""> -->
    ...
    <?php echo($marketing_approve); if ($marketing_approve == "Approved") { ?>
